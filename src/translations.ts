export const translations = {
  en: {
      ...
      view_all_skills: "View all skills and projects →",
      back_to_projects: "← Back to projects",
      launch_interactive: "→ Launch interactive game",
      select_project: "Select a project to view details",
      project_list: {
  ...
  ge: {
    ...
    key_technologies: "Wichtige Technologien:",
    view_all_skills: "Alle Fähigkeiten und Projekte anzeigen →",
    back_to_projects: "← Zurück zu Projekten",
    launch_interactive: "→ Interaktives Spiel starten",
    select_project: "Wählen Sie ein Projekt aus, um Details anzuzeigen",
    project_list: {
